...
#puts "le nombre de journalistes est de #{journalistes.length}" 

#puts journalistes.sort_by(&:length)[0]

#five = []
#puts "nombre de handle composés de 5 lettres"
#journalistes.each do |cinq|
#    if cinq.length == 6
#        five << cinq
#    end
#end
...
#puts journalistes.count {|e| e =~ /^@[A-Z]/}

#puts journalistes.sort_by(&:length)

#puts journalistes.map {|element| element.downcase}.sort

#puts journalistes.index("@epenser")

#puts journalistes.sort_by(&:size)
